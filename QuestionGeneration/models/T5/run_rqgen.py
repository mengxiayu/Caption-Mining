...
question_answering_column_name_mapping = {
    "cs241": ("question", "context", "answer"),
    "rq": {"intro", "relatedWork", "rq", "id"}
}
...
def main():
    ...
    def preprocess_rq_batch(
        ...
        inputs = contexts
        targets = [" ".join(q) for q in questions]
        return inputs, targets


    def preprocess_function(examples):
        inputs, targets = preprocess_rq_batch(examples, question_column, context_column)
